...
from GraspEstimatorOnlyWidthAngle import (
    JacquardDataset,
    GraspPredictorNet,
    custom_collate_fn,
    train_model,
...
from GraspEstimatorOnlyWidthAngle import AugmentRGBOnly
...
BATCH_SIZE = 16
EPOCHS = 5
PRETRAINED_PATH = "grasp_rgbd_mask_augmented_WidthAngleOnly.pth"
OUTPUT_PATH = "grasp_rgbd_mask_finetuned_stereo_augmented_WAOnly.pth"
