...
from GraspEstimatorRGBD import (
    JacquardDataset,
    GraspPredictorNet,
    custom_collate_fn,
    train_model,
...
BATCH_SIZE = 16
EPOCHS = 5
PRETRAINED_PATH = "grasp_rgbd_mask_perfect.pth"
OUTPUT_PATH = "grasp_rgbd_mask_finetuned_stereo.pth"
...
val_dataset = JacquardDataset(val_folders, BASE_PATH, transform=transform, use_stereo_depth=True)
